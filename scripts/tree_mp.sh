...
echo ""
nw_reroot $inputfasta'_mp_boot.raxml.supportFBP' 'hCoV-19/Wuhan/WH04/2020|EPI_ISL_406801|2020-01-05' > $inputfasta'_mp_FBP.tree'
rm $inputfasta'_mp_boot.raxml.supportFBP'

nw_reroot $inputfasta'_mp_boot.raxml.supportTBE' 'hCoV-19/Wuhan/WH04/2020|EPI_ISL_406801|2020-01-05' > $inputfasta'_mp_TBE.tree'
