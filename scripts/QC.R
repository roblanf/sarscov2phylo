...
print("# QC Report for the phylogenetic tree")
print("")
print("## Comparison to previous iteration's tree")
print(paste("wRF distance between previous and new iteration's trees:", obs))
print(paste("This is equivalent to a number of random NNIs equal to roughly:", thresh))
print(paste("This is equivalent to a number of random NNIs equal to roughly:", thresh))
print("")

print("## Clustering of Pangolin lineages")
print(paste(sum(clustering$p<0.5), "out of", nrow(clustering), "Pangolin lineages show significant clustering"))
print("")
