...
writeLines("")
writeLines("## Comparison to previous iteration's tree")
writeLines(paste("wRF distance between previous and new iteration's trees:", obs))
writeLines(paste("This is equivalent to a number of random NNIs equal to roughly:", thresh))
writeLines(paste("This is equivalent to a number of random NNIs equal to roughly:", thresh))
writeLines("")

writeLines("## Clustering of Pangolin lineages")
